...
public class MemorySummaryNewAggregateTest {
  ...
  public static void setUpBeforeClass() throws Exception {
    mockHelper =
        new StepMockHelper<MemorySummaryMeta, MemorySummaryData>( "Memory Group By", MemorySummaryMeta.class,
            MemorySummaryData.class );
    ...
    strings.add( MemorySummaryMeta.TYPE_GROUP_CONCAT_COMMA );
    strings.add( MemorySummaryMeta.TYPE_GROUP_CONCAT_STRING );

    // Statistics will be initialized with collections...
    statistics = new ArrayList<Integer>();
    statistics.add( MemorySummaryMeta.TYPE_GROUP_MEDIAN );
    statistics.add( MemorySummaryMeta.TYPE_GROUP_PERCENTILE );
  }
